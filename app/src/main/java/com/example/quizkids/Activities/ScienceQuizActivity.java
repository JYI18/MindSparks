...
public class ScienceQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Retrieve the level passed from ScienceLevelActivity
...
// Construct the Firebase reference dynamically based on the selected category and level
        String firebasePath = "science/" + category + "/level" + level;
        ...
        Log.d("QuizActivity", "Full Firebase URL: " + "https://mindsparks-b5274-default-rtdb.asia-southeast1.firebasedatabase.app/" + firebasePath);
    ...
    private void loadQuestionsFromFirebase() {
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (!questionsList.isEmpty()) {
                        ...
                        Toast.makeText(ScienceQuizActivity.this, "No questions found", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // No data exists in the path
                    Toast.makeText(ScienceQuizActivity.this, "No data found", Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(ScienceQuizActivity.this, "Failed to load questions: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(TIME_LIMIT, 1000) {  // 30 seconds with 1-second intervals
            ...
            public void onFinish() {
                ...
                Toast.makeText(ScienceQuizActivity.this, "Time's up!", Toast.LENGTH_SHORT).show();
    ...
    private void setAnswerButtonListeners() {
        int selectedColor = getResources().getColor(R.color.science_selected_button_color);
    ...
    private void resetButtonColors() {
        int defaultColor = getResources().getColor(R.color.science_default_button_color);
