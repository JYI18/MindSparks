...
public class AnimalQuizActivity extends AppCompatActivity {
    ...
    private void endQuiz() {
        ...
        // Get the category dynamically
        String category = "animals"; // This can be parameterized or derived

        // Save the score using SharedPreferences
        SharedPreferences prefs = getSharedPreferences("QuizScores", MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt(category + "_score", score); // Save score with category-based key
        editor.apply();

        // Navigate to ViewScoreActivity
    ...
    private void incrementQuizCompletion() {
        ...
        SharedPreferences.Editor editor = prefs.edit();
        editor.putInt("completedQuizzes", completedQuizzes + 1);
        editor.apply();
    }
