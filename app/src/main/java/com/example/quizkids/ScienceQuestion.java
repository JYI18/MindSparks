...
public class ScienceQuestion {
    ...
    // Empty constructor for Firebase or data serialization/deserialization
    public ScienceQuestion() {}

    // Constructor
    public ScienceQuestion(String question, String optionA, String optionB, String optionC, String optionD, String correctAnswer) {
    ...
    public void setScienceQuestion(String question) {
        this.question = question;
    }
